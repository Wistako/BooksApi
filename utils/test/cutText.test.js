...
describe('CutText', () => {
  ...
  it('should return an error if "content" arg is not a string for undefinded', () => {
  ...
  it('should return an error if "content" arg lengt is 0', () => {
    expect(cutText('', 20)).to.equal('Error');
  });

  it('should return an error if ",axLength" arg is not a number', () => {
  ...
  it('should return the same string if "maxLength" is lower or equal 0 ', () => {
